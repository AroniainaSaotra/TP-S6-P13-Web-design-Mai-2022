...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">Rechauffement Climatique</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Augmentation de la température moyenne de la surface terrestre</h1>
          <h2> Modification des régimes météorologiques à grande échelle</h2>
        </div>
      </div>
    </div>
        ...
        <div class="from-group row">
              <div class="card" style="width: 18rem; margin-left:520px;" >
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $cas[$i]['descri']; ?></p>
                  <?php } ?>
                </div>
              </div>
        </div>
